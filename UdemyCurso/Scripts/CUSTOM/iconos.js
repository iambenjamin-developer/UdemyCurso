$.get("/Test/ListarDocentes/", function (data) {

    //llenar tabla alumnos
    llenarTabla(["ID", "NOMBRE", "APELLIDO PATERNO", "APELLIDO MATERNO", "EMAIL", "ACCIONES"], data, "tabla-docentes-iconos");
...
function llenarTabla(arrayCabecera, data, idTagString) {
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        contenido += "<td>";
        contenido += "<button id='btnEditar' class='btn btn-primary'><i class='fas fa-edit'></i></button>   ";
